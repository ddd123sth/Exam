namespace Exam.Back.Common
{
    ...
    public class RedisOperatorBase
    {
        ...
        public bool Set(string key, string value)
        {
            try
            {
                var tmpVal = ServiceStack.Text.JsonSerializer.SerializeToString<string>(value);
        ...
        public string Get(string key)
        {
            try
            {
                ...
                var result = ServiceStack.Text.JsonSerializer.DeserializeFromString<string>(value);
                Dispose();
                return result;
            }
            catch
